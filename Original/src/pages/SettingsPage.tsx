        ...
        <section className="bg-black-soft p-6 rounded-3xl border border-gold/20 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-lg font-bold text-white">Google Photos</h2>
                <p className="text-gold/40 text-sm">Usa Google Photos como tu nube para publicaciones.</p>
              </div>
            </div>
            {googlePhotosConnected ? (
              <button 
                onClick={handleDisconnectGooglePhotos}
                className="px-4 py-2 bg-rose-500/10 text-rose-500 rounded-xl text-sm font-bold hover:bg-rose-500/20 transition-all"
              >
                Desconectar
              </button>
            ) : (
              <button 
                ...
                className="px-4 py-2 bg-gold text-black rounded-xl text-sm font-bold hover:bg-gold-light transition-all"
              >
                Conectar
              </button>
            )}
