...
import { Settings, Grid, UserPlus, Check, Edit3, MessageCircle, Heart, Lock, Clock, UserMinus, ShieldAlert, Cloud } from 'lucide-react';
            ...
            {isOwnProfile ? (
              <div className="flex items-center space-x-3">
                ...
                <button 
                  ...
                  title="Mis Nubes"
                >
                  <Cloud size={20} className="lg:w-7 lg:h-7" />
                </button>
                <button 
                  onClick={() => navigate('/settings')}
                  className="p-2.5 text-gold/60 hover:text-gold transition-colors active:scale-90 rounded-full hover:bg-gold/10"
